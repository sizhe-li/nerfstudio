...
from nerfstudio.models.dnerfacto import DNerfactoModel, DNerfactoModelConfig
from nerfstudio.utils import colormaps


@dataclass
class DepthDNerfactoModelConfig(DNerfactoModelConfig):
    """Additional parameters for depth supervision."""

    _target: Type = field(default_factory=lambda: DepthDNerfactoModel)
...
class DepthDNerfactoModel(DNerfactoModel):
    ...
    config: DepthDNerfactoModelConfig
