...
from nerfstudio.models.autodecode_kplanes import KPlanesModel, KPlanesModelConfig
from nerfstudio.utils import colormaps


@dataclass
class DepthAutoDecodeKPlanesModelConfig(KPlanesModelConfig):
    """Additional parameters for depth supervision."""

    _target: Type = field(default_factory=lambda: DepthAutoDecodeKPlanesModel)
...
class DepthAutoDecodeKPlanesModel(KPlanesModel):
    ...
    config: DepthAutoDecodeKPlanesModelConfig
